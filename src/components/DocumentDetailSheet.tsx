      ...
      <SheetContent side="bottom" className="h-[85vh] rounded-t-2xl overflow-auto">
        ...
        <div className="space-y-5 animate-fade-in">
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-foreground text-sm">{t.details}</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">{t.nameOnDocument}</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                {document.frontImage && (
                  <div className="space-y-1">
                    <p className="text-xs text-muted-foreground">{t.front}</p>
                    <img
          ...
          <div className="pt-3 border-t border-border">
            <p className="text-xs text-muted-foreground">
              {formatDate(document.createdAt)} {t.addedOn}
            </p>
          </div>
        </div>
      </SheetContent>
